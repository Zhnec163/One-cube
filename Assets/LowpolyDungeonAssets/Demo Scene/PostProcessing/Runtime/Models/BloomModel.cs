...
namespace UnityEngine.PostProcessing
{
    ...
    public class BloomModel : PostProcessingModel
    {
        ...
        {
            [MinAttributePoly(0f), Tooltip("Strength of the bloom filter.")]
            public float intensity;

            [MinAttributePoly(0f), Tooltip("Filters out pixels under this level of brightness.")]
        ...
        public struct LensDirtSettings
        {
            ...
            [MinAttributePoly(0f), Tooltip("Amount of lens dirtiness.")]
            public float intensity;
