...
namespace UnityEngine.PostProcessing
{
    ...
    public class EyeAdaptationModel : PostProcessingModel
    {
        ...
        public struct Settings
        {
            ...
            [MinAttributePoly(0f), Tooltip("Exposure bias. Use this to offset the global exposure of the scene.")]
            ...
            [MinAttributePoly(0f), Tooltip("Adaptation speed from a dark to a light environment.")]
            public float speedUp;

            [MinAttributePoly(0f), Tooltip("Adaptation speed from a light to a dark environment.")]
